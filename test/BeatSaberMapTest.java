...
class BeatSaberMapTest {
    ...
    @Test
    void constructor() {
        String OGJson = FileManager.readFile("test/resources/Template--ISeeFire.txt").get(0);
        ...
        assertNull(new BeatSaberMap(map._notes)._events);
        assertNull(new BeatSaberMap(map._notes)._obstacles);
        assertNull(new BeatSaberMap(map._notes).bookmarks);
        ...
        BeatSaberMap map2 = new Gson().fromJson(FileManager.readFile("test/resources/BookmarksExample.txt").get(0), BeatSaberMap.class);
        map2.originalJSON = FileManager.readFile("test/resources/BookmarksExample.txt").get(0);
    }
...
//    }
    ...
    @Test
    void newMapFromJSON() {
        String json = FileManager.readFile("test/resources/BookmarksExample.txt").get(0);
    ...
    @Test
    void exportAsMap() {
        String json1 = FileManager.readFile("test/resources/MinimalMapExample.txt").get(0);
        String json2 = FileManager.readFile("test/resources/MapExample.txt").get(0).replace(",\"_customData\":{\"_time\":15.022}", "");
        String json3 = FileManager.readFile("test/resources/BookmarksExample.txt").get(0).replace("\"_time\":13.492,", "");
        String json4 = FileManager.readFile("test/resources/Template--ISeeFire.txt").get(0).replace(",\"_customData\":{\"_time\":0.121}", "");
        String json5 = FileManager.readFile("test/resources/TimingsExampleMap.txt").get(0).replace(",\"_customData\":{\"_time\":0.121}", "");
    ...
    void convertAllFlashLightsToOnLights() {
        BeatSaberMap map = new Gson().fromJson(FileManager.readFile("test/resources/MapExample.txt").get(0), BeatSaberMap.class);
    ...
    void calculateBookmarks() {
        BeatSaberMap map = new Gson().fromJson(FileManager.readFile("test/resources/BookmarksExample.txt").get(0), BeatSaberMap.class);
        map.originalJSON = FileManager.readFile("test/resources/BookmarksExample.txt").get(0);
