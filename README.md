...
+ **Create Map [(Example)]()**:
  ...
  | **`small jumps`**<br>Depending on the previous notes the blue or red note comes first                                                                                                                                                                                                                          | ![small jumps gif](./assets/small jumps.gif)   |
  | **`normal jumps`**<br>Depending on the previous notes the blue or red note comes first                                                                                                                                                                                                                         | ![normal jumps gif](./assets/normal jumps.gif) |
