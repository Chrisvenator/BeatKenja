 ...
 */
@DisplayName("Note Test: equals and compareTo methods")
class NoteEqualityTest {
    ...
    void testEqualsTimingNoteSameTime() {
        Note note = createNote(5.0f, 1, 1, 0, 2);
        CompareToTest.TimingNote timingNote = new CompareToTest.TimingNote(5.0f);
    ...
    void testEqualsTimingNoteDifferentTime() {
        Note note = createNote(5.0f, 1, 1, 0, 2);
        CompareToTest.TimingNote timingNote = new CompareToTest.TimingNote(6.0f);
